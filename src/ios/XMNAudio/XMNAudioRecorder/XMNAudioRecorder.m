...
- (NSString *_Nullable)stopRecordingWithFileName {
//    [self stopRecording];
    return [self.filePath stringByAppendingString:self.filename];
}
/// ========================================
...
- (void)stopRecordingAndDeleteFile {
    [self stopRecording];
    if (self.filename.length && self.filename.length) {
        NSString *filePathName = [self.filePath stringByAppendingString:self.filename];
        NSFileManager *fm = [NSFileManager defaultManager];
        [fm removeItemAtPath:filePathName error:NULL];
    }
}
